...
namespace TW {
    namespace Ethereum {
        namespace ABI {
            ...
            class ParamArrayFix : public ParamCollection
            {
            private:
                ParamSet _params;
            ...
            public:
                ...
                ParamArrayFix(const std::shared_ptr<ParamBase>& param1) : ParamCollection() { addParam(param1); }
                ParamArrayFix(const std::vector<std::shared_ptr<ParamBase>>& params) : ParamCollection() { setVal(params); }
                ...
                virtual bool isFixArray() const { return true; }
            };
